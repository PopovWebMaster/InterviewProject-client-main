...
export const openStep_1 = () => {
    ...
    let timer = setTimeout( () => {
        ...
        DisplayStep_1.style.zIndex = '200';
        DisplayStep_2.style.zIndex = '100';

        DisplayStep_1.style.opacity = '1';
        DisplayStep_2.style.opacity = '0';

        DisplayStep_1.style.height = '100%';
