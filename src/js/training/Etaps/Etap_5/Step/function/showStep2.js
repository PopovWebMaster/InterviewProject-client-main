...
export const showStep2 = () => {
    ...
    div_step_1.style.opacity =          `0`;
    div_step_1.style.transition =       `opacity ${duration * 0.6}s ease-out`;
    div_step_1.style.transitionDelay =  `0s`;

    span_step_1.style.marginLeft =      `${OFFSET_SPAN_TEXT}%`;
    span_step_1.style.transition =      `margin-left ${duration*1.3}s ease-out`;
    span_step_1.style.transitionDelay =  `0s`;

    div_step_2.style.opacity =          `1`;
    div_step_2.style.transition =       `opacity ${duration * 0.6}s ease-out`;
    div_step_2.style.transitionDelay =  `${duration}s`;

    span_step_2.style.marginLeft =      `0`;
    span_step_2.style.transition =      `margin-left ${duration*1.3}s ease-out`;
    span_step_2.style.transitionDelay =  `${duration*0.6}s`;
